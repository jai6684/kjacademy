...
def show_login():
    ...
    try:
        st.image("attached_assets/kj badminton_1758704159742.jpg", width=200)
    except:
...
def main():
    ...
    # Professional Sports Management UI Styling
    st.markdown("""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap');
    
    /* 🏆 PROFESSIONAL SPORTS MANAGEMENT UI */
    :root {
        --primary-blue: #1976D2;
