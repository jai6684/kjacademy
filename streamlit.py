...
def show_login():
    ...
    try:
        st.image("attached_assets/kj badminton_1758704159742.jpg", width=300)
    except:
...
def main():
    ...
    @media (max-width: 768px) {
        ...
        /* AGGRESSIVE MOBILE TOUCH TARGET FIXING */
        /* Override ALL interactive elements to meet 48px minimum */
        
        /* ALL INPUT ELEMENTS - Multiple targeting strategies */
        input,
        select,
        textarea,
        button,
        ...
        /* FORCE CONTAINER HEIGHT for Streamlit components */
        .stTextInput,
        .stTextInput div,
        .stSelectbox,
        .stSelectbox div,
        ...
        /* NUCLEAR OPTION - Global mobile override */
        * {
